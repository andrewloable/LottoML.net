...
namespace Lotto649
{
    public partial class Slot1
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"col3_LB")]
            public float[] Col3_LB { get; set; }

            [ColumnName(@"col3_UB")]
            public float[] Col3_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"G:\projects\loabletech\LottoML.net\lotto649\slot1.mlnet");
