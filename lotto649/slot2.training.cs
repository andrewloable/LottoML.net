...
namespace Lotto649
{
    public partial class Slot2
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:37,seriesLength:221,trainSize:308,horizon:3,outputColumnName:@"col5",inputColumnName:@"col5",confidenceLowerBoundColumn:@"col5_LB",confidenceUpperBoundColumn:@"col5_UB");
